...
# File: ./tests/scitex/ai/llm/test__Perplexity.py

"""Tests for scitex_genai.llm._Perplexity module."""
...
class TestPerplexity:
    ...
    def test_init_client(self):
        ...
        with patch("scitex_genai.llm._Perplexity.OpenAI") as mock_openai_class:
            mock_client = Mock()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Perplexity.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # Time-stamp: "2024-11-11 04:11:10 (ywatanabe)"
# # File: ./scitex_repo/src/scitex/ai/llm/_Perplexity.py
#
# """
# Functionality:
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Perplexity.py
# --------------------------------------------------------------------------------
