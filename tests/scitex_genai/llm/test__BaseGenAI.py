...
# File: /ssh:sp:/home/ywatanabe/proj/SciTeX-Code/tests/scitex/ai/llm/test__BaseGenAI.py
# ----------------------------------------
import os

__FILE__ = "./tests/scitex/ai/llm/test__BaseGenAI.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------
# Time-stamp: "2025-06-01 13:40:00 (ywatanabe)"

"""Tests for scitex_genai.llm._BaseGenAI module."""
...
class TestBaseGenAI:
    ...
    def gen_ai(self, mock_models):
        ...
        with patch("scitex_genai.llm._BaseGenAI.MODELS", mock_models):
            ai = ConcreteGenAI(
                model="test-model",
    ...
    def test_call_with_prompt_file(self, gen_ai):
        ...
        with patch(
            "scitex_genai.llm._BaseGenAI.load",
    ...
    def test_cost_calculation(self, gen_ai):
        ...
        with patch("scitex_genai.llm._BaseGenAI.calc_cost", return_value=0.15):
    ...
    def test_format_output(self, gen_ai):
        ...
        with patch(
            "scitex_genai.llm._BaseGenAI.format_output_func",
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_BaseGenAI.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Timestamp: "2025-05-03 11:55:54 (ywatanabe)"
# # File: /home/ywatanabe/proj/scitex_repo/src/scitex/ai/llm/_BaseGenAI.py
# # ----------------------------------------
# import os
#
# __FILE__ = "./src/scitex/ai/llm/_BaseGenAI.py"
# __DIR__ = os.path.dirname(__FILE__)
# # ----------------------------------------
#
# import base64
...
#
# """
# python src/scitex/ai/llm/_BaseGenAI.py
# python -m src.scitex_genai.llm._BaseGenAI
# """
#
# # EOF

# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_BaseGenAI.py
# --------------------------------------------------------------------------------
