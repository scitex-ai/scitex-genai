...
# File: ./tests/scitex/ai/llm/test__Llama.py

"""Tests for scitex_genai.llm._Llama module."""
...
class TestLlama:
    ...
    def test_environment_setup(self, mock_env_setup):
        ...
        with patch.object(Llama, "_init_client", return_value=Mock()):
            with patch.object(Llama, "verify_model"):
                with patch("scitex_genai.llm._Llama.print_envs") as mock_print:
                    llama_ai = Llama(model="Meta-Llama-3-8B", api_key="test-key")
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Llama.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Time-stamp: "2024-11-05 21:11:08 (ywatanabe)"
# # File: ./scitex_repo/src/scitex/ai/llm/_Llama.py
#
# """Imports"""
#
# import os
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Llama.py
# --------------------------------------------------------------------------------
