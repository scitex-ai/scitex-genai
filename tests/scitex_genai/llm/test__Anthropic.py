...
# File: /ssh:sp:/home/ywatanabe/proj/SciTeX-Code/tests/scitex/ai/llm/test__Anthropic.py
# ----------------------------------------
import os

__FILE__ = "./tests/scitex/ai/llm/test__Anthropic.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------

# Time-stamp: "2025-06-01 14:20:00 (ywatanabe)"

"""Tests for scitex_genai.llm._Anthropic module."""
...
class TestAnthropic:
    ...
    def test_init_with_api_key(self, mock_env_api_key):
        ...
        with patch("scitex_genai.llm._PARAMS.MODELS", MagicMock()):
    ...
    def test_model_validation(self, mock_env_api_key):
        ...
        with patch("scitex_genai.llm._PARAMS.MODELS", mock_models):
            with patch.object(Anthropic, "_init_client", return_value=Mock()):
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Anthropic.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Timestamp: "2025-06-24 19:20:24 (ywatanabe)"
# # File: /home/ywatanabe/proj/scitex_repo/src/scitex/ai/llm/_Anthropic.py
# # ----------------------------------------
# import os
#
# __FILE__ = __file__
...
#
# """
# python src/scitex/ai/llm/_Anthropic.py
# python -m src.scitex_genai.llm._Anthropic
# """
#
# # EOF

# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_Anthropic.py
# --------------------------------------------------------------------------------
