...
# File: /ssh:sp:/home/ywatanabe/proj/SciTeX-Code/tests/scitex/ai/llm/test__DeepSeek.py
# ----------------------------------------
import os

__FILE__ = "./tests/scitex/ai/llm/test__DeepSeek.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------
# Time-stamp: "2025-06-01 14:30:00 (ywatanabe)"

"""Tests for scitex_genai.llm._DeepSeek module."""
...
class TestDeepSeek:
    ...
    def test_init_client(self, mock_models):
        ...
        with patch.object(DeepSeek, "verify_model"):
            with patch("scitex_genai.llm._DeepSeek._OpenAI") as mock_openai_class:
                mock_client = Mock()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_DeepSeek.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Time-stamp: "2024-11-08 20:33:49 (ywatanabe)"
# # File: ./scitex_repo/src/scitex/ai/llm/_DeepSeek.py
#
# """
# 1. Functionality:
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/ai/llm/_DeepSeek.py
# --------------------------------------------------------------------------------
