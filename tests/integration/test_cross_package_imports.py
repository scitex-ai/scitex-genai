"""Cross-package import gate (PS-140) for scitex-genai.
...
generated-by: scitex-dev 0.60.2.dev25+g4b298ce60
...
Regenerate with:
    ...
    scitex-dev ecosystem install-cross-package-gate scitex-genai --force
