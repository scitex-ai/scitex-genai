# Contributing to SciTeX GenAI

Thank you for your interest in contributing to SciTeX GenAI. This guide covers the
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-genai/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-genai` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-genai.git
cd scitex-genai
pip install -e ".[dev]"
```
