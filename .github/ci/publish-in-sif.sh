...
# (project=scitex-genai, owner=ywatanabe1989, repo=scitex-genai,
...
TMPDIR="/tmp/publish-scitex_genai-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-genai dist/* uploaded to PyPI via manual OIDC trusted publishing"
